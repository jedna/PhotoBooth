	...
	export default {
		...
		data () {
			return {
				msg: 'Test',
				photos: [
					{name: 'test1', path: 'http://placehold.it/350x250', thumb: 'http://placehold.it/350x250', active: true},
					{name: 'test2', path: 'http://placehold.it/350x250', thumb: 'http://placehold.it/350x250', active: true}
				]
			}
		},
		components: {
